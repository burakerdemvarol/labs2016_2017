...
public class Classroom {
 ...
 public void addStudent(Student newStudent) throws Exception
 {
   ...
   try{
     ...
     for(int i = 0; i < size; i++){
       if(newStudent.equals(students[i]))
         throw new StudentAlreadyFoundException();
  ...
  size++;
     ...
     System.out.println("You can not add student because class bounds!!");
   }  
 }
 /*
  ...
  */
 public void printIntoFile( String fileName) throws Exception {
  ...
  */
 public void appendToFile( String fileName) throws Exception {
   ...
   try{
     if ( f.exists() ) {
       ...
       System.out.println("File did not find by program");
     }
   }catch(Exception e) {
     e.printStackTrace();
   }
